...
void VoronoiDiagramGenerator::resetIterator()
{
...
void VoronoiDiagramGenerator::resetDelaunayEdgesIterator()
{
	iteratorDelaunayEdges = delaunayEdges;
}

bool VoronoiDiagramGenerator::getNextDelaunay(float& x1, float& y1, float& x2, float& y2)
{
...
void VoronoiDiagramGenerator::resetVertexPairIterator()
{
	currentVertexLink = 0;
}

void VoronoiDiagramGenerator::resetVerticesIterator()
{
	currentVertex = 0;
}

bool VoronoiDiagramGenerator::getNextVertex(float& x, float& y)
{
	if(finalVertices == 0)
		return false;
